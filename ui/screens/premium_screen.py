...
class PremiumScreen(ft.Column):
    ...
    def __init__(self, page: ft.Page, on_premium_changed=None):
        ...
        status = PremiumService.get_status()
        self.is_premium = status["is_premium"]
        self.premium_expires = status["expires_at"]
    ...
    def _star_halo(self, color):
        return ft.Container(
            ...
            bgcolor=with_alpha(color, 0x10), alignment=ft.Alignment(0, 0),
            content=ft.Container(
                width=70, height=70, border_radius=35,
                bgcolor=with_alpha(color, 0x22), alignment=ft.Alignment(0, 0),
    ...
    def _status_card(self):
        ...
        return ft.Container(
            content=body, padding=ft.padding.Padding(20, 26, 20, 26),
    ...
    def _section_title(self, text, accent):
        return ft.Container(
            content=ft.Row([
                ...
                ft.Text(text.upper(), size=12, weight=ft.FontWeight.BOLD, color=COLORS["text_secondary"]),
    ...
    def _feature_row(self, icon, title, subtitle, color, gated=False, coming=False):
        ...
        row = ft.Container(
            content=ft.Row([
                ft.Container(content=ft.Icon(icon, size=22, color=color),
            ...
            shadow=SHADOWS["card"], opacity=0.7 if (locked or coming) else 1.0,
        )
